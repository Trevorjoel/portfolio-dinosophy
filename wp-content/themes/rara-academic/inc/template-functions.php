...
*/
    ...
    ?>
		<div class="site-info">
			<p>
				<?php echo esc_html__( '&copy; Copyright ', 'rara-academic' ) . date('Y'); ?> 
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></a>.
				
                <a href="<?php echo esc_url( 'http://raratheme.com/wordpress-themes/rara-academic/' ); ?>" rel="author" target="_blank"><?php echo esc_html__( 'Rara Academic by Rara Theme.', 'rara-academic' ); ?></a>
